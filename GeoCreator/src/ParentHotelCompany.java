...
public enum ParentHotelCompany {
    ...
    */
    ...
    HILTON("Hilton", "hilton",
            "(\\bHilton\\b)|(\\bConrad\\b)|(\\bDoubletree\\b)|(Double tree\\b)|(\\bEmbassy Suites)|(\\bHampton by\\b)|(\\bHampton Inn\\b)|(Homewood Suites)|(\\bEmily Morgan)|(Waldorf Astoria)",
            "(\\bHilton\\b)|(\\bConrad\\b)|(\\bDoubletree\\b)|(Double.*tree\\b)|(\\bEmbassy.*Suites)|(\\bHampton\\b)|(Homewood.*Suites)|(\\bEmily.*Morgan)|(Waldorf.*Astoria)"),
    ...
    STARWOOD("Starwood", "starwood",
            "(Sheraton)|(four points)|(aloft)|(le meridien)|(luxury collection)|(element (?!on ))|(Westin )|( Westin$)|(^(The )*St Regis )|(^St. Regis)|(^itc\\b)|(^w hotel)|( w hotel)",
            "(Sheraton)|(four.*points)|(aloft)|(le.*meridien)|(luxury.*collection)|(element)|(Westin)|( Westin$)|(^(The )*St Regis )|(^St. Regis)|(^itc\\b)|(^w hotel)|( w hotel)"),
